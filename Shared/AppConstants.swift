...
enum AppConstants {
    ...
    static let notifyHabitsEnabledKey = "goalstar.notify.habitsEnabled"
    static let notifyTasksHourKey = "goalstar.notify.tasksHour"
    static let notifyTasksMinuteKey = "goalstar.notify.tasksMinute"
    static let notifyHabitsHourKey = "goalstar.notify.habitsHour"
    static let notifyHabitsMinuteKey = "goalstar.notify.habitsMinute"
